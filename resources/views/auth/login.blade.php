...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="font-weight: bold;" class="card-header">{{ __('Ke správě těchto stránek je nutné administrátorské přihlášení:') }}</div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button style="border-radius: 0%; border:none; background-color:darkorange" type="submit" class="btn btn-primary">
                                    {{ __('Přihlásit se') }}
                                </button>
